...
const (
	...
	MessageType_TRACE     MessageType = 8
)
...
type TraceStep int32

const (
	TraceStep_GOST_QUERY_RECEIVED TraceStep = 0
	TraceStep_GOST_DB_EXECUTED    TraceStep = 1
	TraceStep_GOST_RESULT_SENT    TraceStep = 2
)

// Enum value maps for TraceStep.
var (
	TraceStep_name = map[int32]string{
		0: "GOST_QUERY_RECEIVED",
		1: "GOST_DB_EXECUTED",
		2: "GOST_RESULT_SENT",
	}
	TraceStep_value = map[string]int32{
...
func (x TraceStep) Enum() *TraceStep {
	p := new(TraceStep)
	*p = x
	return p
}
...
func (TraceStep) Descriptor() protoreflect.EnumDescriptor {
	return file_modules_proto_agent_proto_enumTypes[1].Descriptor()
}

func (TraceStep) Type() protoreflect.EnumType {
	return &file_modules_proto_agent_proto_enumTypes[1]
}

func (x TraceStep) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TraceStep.Descriptor instead.
func (TraceStep) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	Command_DEACTIVATE_APP Command = 4
	Command_REACTIVATE_APP Command = 5
)
...
type TraceEvent struct {
	...
	Step          TraceStep              `protobuf:"varint,2,opt,name=step,proto3,enum=agent.TraceStep" json:"step,omitempty"`
...
func (x *TraceEvent) GetBatchId() string {
	if x != nil {
		return x.BatchId
	}
	return ""
...
func (x *TraceEvent) GetStep() TraceStep {
	if x != nil {
		return x.Step
	}
	return TraceStep_GOST_QUERY_RECEIVED
}
...
func (x *TraceEvent) GetDurationMs() int32 {
	if x != nil {
		return x.DurationMs
	}
	return 0
...
func (x *TraceEvent) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *Commands) GetConfigure() *ConfigurePayload {
	if x != nil {
		if x, ok := x.AddInfo.(*Commands_Configure); ok {
			return x.Configure
		}
	}
	return nil
...
type Commands_Configure struct {
	Configure *ConfigurePayload `protobuf:"bytes,4,opt,name=configure,proto3,oneof"` // new
}
...
func (*Commands_Configure) isCommands_AddInfo() {}
...
func (x *ConfigurePayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigurePayload) ProtoMessage() {}

func (x *ConfigurePayload) ProtoReflect() protoreflect.Message {
	mi := &file_modules_proto_agent_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigurePayload.ProtoReflect.Descriptor instead.
func (*ConfigurePayload) Descriptor() ([]byte, []int) {
	return file_modules_proto_agent_proto_rawDescGZIP(), []int{2}
}

func (x *ConfigurePayload) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *ConfigurePayload) GetUser() string {
	if x != nil {
		return x.User
	}
	return ""
...
const file_modules_proto_agent_proto_rawDesc = "" +
	...
	"\x04step\x18\x02 \x01(\x0e2\x10.agent.TraceStepR\x04step\x12\x1c\n" +
	...
	"\amessage\x18\a \x01(\tR\amessage\"\xc1\x01\n" +
	"\bCommands\x12\"\n" +
	...
	"\aversion\x18\x03 \x01(\tH\x00R\aversion\x127\n" +
	"\tconfigure\x18\x04 \x01(\v2\x17.agent.ConfigurePayloadH\x00R\tconfigureB\t\n" +
	"\aaddInfo\"<\n" +
	"\x10ConfigurePayload\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x12\n" +
	"\x04user\x18\x02 \x01(\tR\x04user\"\xa5\x02\n" +
